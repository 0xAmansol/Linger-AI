...
const PLACEHOLDER_TEXT = `[Mock OCR — set GOOGLE_CLOUD_VISION_CREDENTIALS_BASE64 for real text extraction]

This is placeholder text standing in for what a real photo would produce. Edit this into the actual passage you captured, or configure Google Cloud Vision to extract it automatically next time.`;
